<template>
  <FullScreenLayout>
    <div class="relative p-6 bg-white z-1 dark:bg-gray-900 sm:p-0">
      <div class="relative flex items-center justify-center w-full h-screen dark:bg-gray-900">
        <div class="w-full max-w-md p-8 sm:p-10 bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700">
          <div>
            ...
            <div>
              <form @submit.prevent="handleSubmit">
                <div class="space-y-5">
                  <!-- Usuario -->
                  <div>
                    <label for="usuario" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400 text-left">
                  ...
                  <!-- Contraseña -->
                  <div>
                    <label for="password" class="mb-1.5 block text-sm font-medium text-gray-700 dark:text-gray-400 text-left">
